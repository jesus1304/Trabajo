...
@Composable
fun EntrenadorBorrar(navController: NavHostController) {
    ...
    Card(
        ...
        Column(
            ...
            Column(
                ...
                Text(
                    text = "Este futbolista ya no está activo en el equipo desde la última temporada. No ha participado en ningún juego oficial y su contrato ha expirado. Mantenerlo en la base de datos puede generar confusiones y afectar la precisión de los datos actuales. Se recomienda eliminar su perfil para mantener la información actualizada y facilitar la gestión de futbolistas activos.",
                    style = TextStyle(
                        fontSize = 16.sp
                    ),
                    modifier = Modifier
