...
@Composable
fun Aqua(navController: NavHostController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.aqua2),
                ...
                modifier = Modifier
                    ...
                    Text(
                        text = "Beneficios de Aqua\n" +
                                "\n" +
                                "1.Mayor resistencia\n" +
                                "Aumenta la capacidad del corazón y mejora la circulación.\n" +
                                "\n" +
                                "2.Reducción del tiempo de recuperación\n" +
                                "Tolerancia al lactato para soportar esfuerzos más intensos más tiempo y recuperar antes entre ellos.\n" +
                                "\n" +
                                "3.Mejora la salud\n" +
                                "La práctica de mente y cuerpo es buena para la salud del corazón, aparato digestivo y respiratorio.\n" +
                                "\n" +
                                "4.Mejora de la capacidad respiratoria\n" +
                                "Aumenta la eliminación de gases como dióxido de carbono y mejora en la toma de oxígeno, capaz de mejorar el equilibrio O2/CO2.",
                        style = TextStyle(
                            fontSize = 19.sp
                        ),
                        modifier = Modifier
            ...
            LaunchedEffect(Unit) {
                ...
                db.collection(coleccion)
                    ...
                    .addOnSuccessListener { resultado ->
                        ...
                        }.filter { it.nombre.equals("aqua", ignoreCase = true) } // Filtrar por nombre
