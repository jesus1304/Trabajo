...
fun Fitness(navController: NavHostController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "1.Mejora integral: " +
                        "Favorece el desarrollo de fuerza, resistencia y flexibilidad en una sola sesión.\n" +
                        "2.Motivación extra:" +
                        " El ambiente grupal y la música energizante aumentan la motivación y el compromiso.\n" +
                        "3.Variedad de rutinas:" +
                        " Ofrece diversidad en los ejercicios para evitar la monotonía y trabajar distintos grupos musculares.\n" +
                        "4.Profesionalización:" +
                        " Instructores capacitados guían y corrigen para asegurar una práctica segura y efectiva.",
                style = TextStyle(
                    fontSize = 19.sp
                ),
                modifier = Modifier
