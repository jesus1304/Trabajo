    ...
    Scaffold(
        ...
        Column(
            ...
            verticalArrangement = Arrangement.spacedBy(10.dp),
                    ...
                    Text(
                        text = "Beneficios de AQUA Health\n" +
                                "\n" +
                                "1.Corrección postural\n" +
                                "Alineación de segmentos corporales, activación de musculatura profunda y control corporal completo.\n" +
                                "\n" +
                                "2.Reducción de dolores de espalda\n" +
                                "Estabilidad de la columna, ganancia de fuerza en la musculatura profunda del CORE.\n" +
                                "\n" +
                                "3.Prevención de lesiones\n" +
                                "Ayuda a evitar posibles lesiones gracias al alivio muscular.\n" +
                                "\n" +
                                "4.Mejora la salud\n" +
