...
@Composable
fun Yoga(navController: NavHostController) {
            ...
            Column(
                ...
                verticalArrangement = Arrangement.spacedBy(10.dp),
                    ...
                    Image(
                        ...
                        Text(
                            text = "                       Beneficios del Yoga\n" +
                                    "\n" +
                                    "   1.Reduce el estrés\n" +
                                    "Ayuda a reducir el nivel de cortisol, lo que mejora el humor, sueño y el sistema inmunológico.\n" +
                                    "\n" +
                                    "   2.Mejora la salud\n" +
                                    "La práctica de mente y cuerpo es buena para la salud del corazón, aparato digestivo y respiratorio.\n" +
                                    "\n" +
                                    "   3.Fortalece la espalda\n" +
                                    "Elimina dolores de espalda y malas posturas, además de tonificar todo el cuerpo.\n" +
                                    "\n" +
                                    "   4.Mayor equilibrio\n" +
                                    "Agudiza la percepción espacial, visual y sensorial, fortaleciendo huesos y masa muscular.",
                            style = TextStyle(
                                fontSize = 19.sp
                            ),
                            modifier = Modifier
                ...
                LaunchedEffect(Unit) {
                    ...
                    db.collection(coleccion)
                        ...
                        .addOnSuccessListener { resultado ->
                            ...
                            }.filter { it.nombre.equals("yoga", ignoreCase = true) } // Filtrar por nombre
