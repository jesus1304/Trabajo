...
@Composable
fun StepFuncional(navController: NavHostController) {
            ...
            BottomAppBar(
                ...
                contentColor = MaterialTheme.colorScheme.primary,
                            ...
                            verticalArrangement = Arrangement.spacedBy(10.dp),
                                        ...
                                        Text(
                                            text = "El step funcional ofrece beneficios físicos como:\n" +
                                                    "\n" +
                                                    "1.Cardiovascular: Mejora la salud del corazón y los pulmones.\n" +
                                                    "\n" +
                                                    "2.Quema de calorías: Ayuda a perder peso y quemar grasa.\n" +
                                                    "\n" +
                                                    "3.Fortalecimiento muscular: Trabaja piernas, glúteos y pantorrillas.\n" +
                                                    "\n" +
                                                    "4.Mejora del equilibrio y la coordinación: Aumenta la habilidad para mantener el equilibrio y coordinar movimientos.\n" +
                                                    "\n" +
                                                    "5.Bajo impacto: Menos estresante para las articulaciones.\n" +
                                                    "\n" +
                                                    "6.Versatilidad: Permite realizar una amplia variedad de ejercicios.",
                                            style = TextStyle(
                                                fontSize = 19.sp
                                            ),
                                            modifier = Modifier
                                        ...
                                        LaunchedEffect(Unit) {
                                            ...
                                            db.collection(coleccion)
                                                ...
                                                .addOnSuccessListener { resultado ->
                                                    ...
                                                    }.filter { it.nombre.equals("Step Funcional", ignoreCase = true) } // Filtrar por nombre
                                ...
                                Column(
                                                    ...
                                                    onClick = {
                                                        ...
                                                        db.collection("clasesReserva")
                                                            ...
                                                            .addOnFailureListener { exception ->
                                                                ...
                                                                Log.e(
                                                                    "Reserva",
                                                                    "Error al guardar la reserva: $exception"
                                                                )
                                                            }
                                    ...
                                    Button(
                                        ...
                                        modifier = Modifier.padding(
                                            ...
                                            .fillMaxWidth(),
                                        colors = ButtonDefaults.buttonColors(
                                            containerColor = if (reservaConfirmada && !puntosOtorgados) Color(
                                                0xFF4CAF50
                                            ) else Color.Gray,
                                            contentColor = Color.White
                                        ),
